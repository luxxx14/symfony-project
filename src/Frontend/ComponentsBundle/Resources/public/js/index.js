$(document).ready(function(){
	...
	$('.show-components .show-components__text, .download-versions__item-icon').on('click', function() {
		if(parseInt($(this).closest('.show-components').find('.show-components__text').css('marginBottom')) > 0) {
			$(this).closest('.show-components').find('.show-components__text').css('marginBottom', 0);
		} else {
			$(this).closest('.show-components').find('.show-components__text').css('marginBottom', $(this).closest('.show-components').find('.components').css('height'));
		}

		$(this).closest('.show-components').find('.components').toggle();
	});
});
